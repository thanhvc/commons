...
public final class NotificationContextImpl implements NotificationContext {
  ...
  private final PluginConfigService settingService;
  ...
  private NotificationContextImpl() {
    ...
    settingService = CommonsUtils.getService(PluginConfigService.class);
  }
  ...
  public PluginConfigService getPluginSettingService() {
